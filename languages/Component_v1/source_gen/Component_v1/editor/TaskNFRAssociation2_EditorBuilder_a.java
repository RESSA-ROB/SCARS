...
/*package*/ class TaskNFRAssociation2_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new NFRsListHandler_g1p9eb_c0a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_NFRs");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class NFRsListHandler_g1p9eb_c0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public NFRsListHandler_g1p9eb_c0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(NFRsListHandler_g1p9eb_c0a.this.getNode(), LINKS.NFRs$MSud));
      try {
