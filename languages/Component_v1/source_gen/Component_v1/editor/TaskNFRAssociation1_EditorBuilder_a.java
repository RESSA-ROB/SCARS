...
/*package*/ class TaskNFRAssociation1_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new NFRsListHandler_1mw0v7_c0a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_NFRs");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class NFRsListHandler_1mw0v7_c0a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public NFRsListHandler_1mw0v7_c0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.NFRs$SGTG;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ILocalRunTimeNFRsInst$KX;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(NFRsListHandler_1mw0v7_c0a.this.getNode(), LINKS.NFRs$SGTG));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SInterfaceConcept ILocalRunTimeNFRsInst$KX = MetaAdapterFactory.getInterfaceConcept(0xddad85b58f7640d8L, 0x9a0dbd322c713e77L, 0x4430c773569164c0L, "NFR.structure.ILocalRunTimeNFRsInst");
  }
