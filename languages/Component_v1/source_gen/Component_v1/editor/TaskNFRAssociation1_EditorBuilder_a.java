...
/*package*/ class TaskNFRAssociation1_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public TaskNFRAssociation1_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_1mw0v7_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_1mw0v7_a0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.tasks$SHnI;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.tasks$SHnI);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.tasks$SHnI);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_1mw0v7_b0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new NFRsSingleRoleHandler_1mw0v7_c0a(myNode, LINKS.NFRs$SGTG, getEditorContext());
    return provider.createCell();
  }
  private static class NFRsSingleRoleHandler_1mw0v7_c0a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public NFRsSingleRoleHandler_1mw0v7_c0a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.NFRs$SGTG, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.NFRs$SGTG, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.NFRs$SGTG);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.NFRs$SGTG));
      try {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_1mw0v7_d0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.value$xoLa;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private EditorCell createEmpty_0() {
    ...
    editorCell.setCellId("Empty_1mw0v7_b0");
    return editorCell;
  }
