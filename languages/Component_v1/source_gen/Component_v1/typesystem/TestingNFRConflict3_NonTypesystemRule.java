...
public class TestingNFRConflict3_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public TestingNFRConflict3_NonTypesystemRule() {
  }
          ...
          while (robot_it.hasNext()) {
            robot_var = robot_it.next();
            {
              ...
              while (subcomp_it.hasNext()) {
                ...
                {
                  Iterator<SNode> nfr_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(subcomp_var, LINKS.mobilerobot$ZnYh), LINKS.nfr$86Bz)).iterator();
                  SNode nfr_var;
                ...
                indexChosen = 0;
                {
                  Iterator<String> item_it = ListSequence.fromList(NFR_names).iterator();
                  String item_var;
                  while (item_it.hasNext()) {
                    item_var = item_it.next();
                    int index = ListSequence.fromList(NFR_names).indexOf(item_var);
                    indexChosen = index;
                    if (item_var.contains("Usability")) {
                      flag = 1;
                    }
                ...
                indexChosen = 0;
                {
                  ...
                  while (item_it.hasNext()) {
                    ...
                    int index = ListSequence.fromList(NFR_names).indexOf(item_var);
                    indexChosen = index;
                    if (item_var.contains("Efficiency") && !(item_var.contains("EnergyEfficiency"))) {
                      flag = 1;
                    }
                    if (flag == 1) {
                      // Expected value of cost
                ...
                indexChosen = 0;
                {
                  ...
                  while (item_it.hasNext()) {
                    ...
                    int index = ListSequence.fromList(NFR_names).indexOf(item_var);
                    indexChosen = index;
                    if (item_var.contains("Robustness")) {
                      flag = 1;
                    }
                    if (flag == 1) {
                      // Expected value of cost
                ...
                indexChosen = 0;
                {
                  ...
                  while (item_it.hasNext()) {
                    ...
                    int index = ListSequence.fromList(NFR_names).indexOf(item_var);
                    indexChosen = index;
                    if (item_var.contains("Reliability")) {
                      flag = 1;
                    }
                    if (flag == 1) {
                      // Expected value of cost
                ...
                id = "";
                {
                  Iterator<String> item_it = ListSequence.fromList(NFR_nameListDummy).iterator();
                  String item_var;
                  while (item_it.hasNext()) {
                    item_var = item_it.next();
                    int index = ListSequence.fromList(NFR_nameListDummy).indexOf(item_var);
                    if (item_var.contains("Availability")) {
                      name = "Availability";
                      id = ListSequence.fromList(NFR_idListall).getElement(index);
                      String nfrid = name + "-" + id;
                      ListSequence.fromList(NFR_idListconcise).addElement(nfrid);
                ...
                id = "";
                {
                  ...
                  while (item_it.hasNext()) {
                    item_var = item_it.next();
                    int index = ListSequence.fromList(NFR_nameListDummy).indexOf(item_var);
                    if (item_var.contains("DeviceCapability")) {
                ...
                id = "";
                {
                  ...
                  while (item_it.hasNext()) {
                    item_var = item_it.next();
                    int index = ListSequence.fromList(NFR_nameListDummy).indexOf(item_var);
                    if (item_var.contains("DataInput")) {
                      name = "DataInput";
                      id = ListSequence.fromList(NFR_idListall).getElement(index);
                      String nfrid = name + "-" + id;
                      ListSequence.fromList(NFR_idListconcise).addElement(nfrid);
                ...
                id = "";
                {
                  ...
                  while (item_it.hasNext()) {
                    item_var = item_it.next();
                    int index = ListSequence.fromList(NFR_nameListDummy).indexOf(item_var);
                    if (item_var.contains("Performance")) {
                      name = "Performance";
                      id = ListSequence.fromList(NFR_idListall).getElement(index);
                      String nfrid = name + "-" + id;
                      ListSequence.fromList(NFR_idListconcise).addElement(nfrid);
                ...
                id = "";
                {
                  ...
                  while (item_it.hasNext()) {
                    item_var = item_it.next();
                    int index = ListSequence.fromList(NFR_nameListDummy).indexOf(item_var);
                    if (item_var.contains("EnergyEfficiency")) {
                ...
                String vars = "v";
                {
                  Iterator<SNode> fgoal_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(subcomp_var, LINKS.mobilerobot$ZnYh), LINKS.tasks$h26j)).iterator();
                  SNode fgoal_var;
                  while (fgoal_it.hasNext()) {
                    fgoal_var = fgoal_it.next();
                    String goalName = SPropertyOperations.getString(fgoal_var, PROPS.name$MnvL);
                    String objective = "Scenario - " + scenarioid + " Mobile Robot: " + SPropertyOperations.getString(SLinkOperations.getTarget(robot_var, LINKS.mobilerobot$ZnYh), PROPS.name$MnvL) + " Sub Component: " + SPropertyOperations.getString(SLinkOperations.getTarget(subcomp_var, LINKS.mobilerobot$ZnYh), PROPS.name$MnvL) + " Functional Objective: " + goalName;
                    // Creation of Objective Function
                    {
                      Iterator<SNode> goal2_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(subcomp_var, LINKS.mobilerobot$ZnYh), LINKS.association$KtsF)).iterator();
                      SNode goal2_var;
                    ...
                    }
                    {
                      ...
                      IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(system, objective, "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "1947599972197786948", null, errorTarget);
                    }
                ...
                for (SNode hardware : ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(subcomp_var, LINKS.mobilerobot$ZnYh), LINKS.hardware$7Z_5))) {
                  {
                    Iterator<SNode> nfr_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(hardware, LINKS.hardware$nR7k), LINKS.component$ISi3), LINKS.nfr$8n9A)).iterator();
                    SNode nfr_var;
                    while (nfr_it.hasNext()) {
                      nfr_var = nfr_it.next();
                      SEnumerationLiteral NFRname = SPropertyOperations.getEnum(nfr_var, PROPS.nfrmetric$_HW4);
                      ...
                      String min = SPropertyOperations.getString(nfr_var, PROPS.minvalue$_Iq6);
                      String mostlikely = SPropertyOperations.getString(nfr_var, PROPS.mostlikely$_N$s);
                      id = SPropertyOperations.getString(nfr_var, PROPS.name$MnvL);
                      ListSequence.fromList(NFR_maxValues).addElement(Double.valueOf(max));
                      ListSequence.fromList(NFR_minValues).addElement(Double.valueOf(min));
                      ListSequence.fromList(NFR_mostlikelyValues).addElement(Double.valueOf(mostlikely));
                      ListSequence.fromList(NFR_idList).addElement(id);
                  ...
                  vars = "v";
                  {
                    Iterator<SNode> fgoal_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(hardware, LINKS.hardware$nR7k), LINKS.component$ISi3), LINKS.tasks$8noB)).iterator();
                    SNode fgoal_var;
                    while (fgoal_it.hasNext()) {
                      fgoal_var = fgoal_it.next();
                      String goalName = SPropertyOperations.getString(fgoal_var, PROPS.name$MnvL);
                      String objective = "Scenario - " + scenarioid + " Mobile Robot: " + SPropertyOperations.getString(SLinkOperations.getTarget(robot_var, LINKS.mobilerobot$ZnYh), PROPS.name$MnvL) + " Sub Component: " + SPropertyOperations.getString(SLinkOperations.getTarget(subcomp_var, LINKS.mobilerobot$ZnYh), PROPS.name$MnvL) + " Hardware: " + SPropertyOperations.getString(SLinkOperations.getTarget(hardware, LINKS.hardware$nR7k), PROPS.name$MnvL) + " Functional Objective: " + fgoal_var;
                      // Creation of Objective Function
                      {
                        Iterator<SNode> goal2_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(hardware, LINKS.hardware$nR7k), LINKS.component$ISi3), LINKS.association$8nBC)).iterator();
                        SNode goal2_var;
                        while (goal2_it.hasNext()) {
                          goal2_var = goal2_it.next();
                      ...
                      {
                        final MessageTarget errorTarget = new NodeMessageTarget();
                        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(system, objective, "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "1947599972197916546", null, errorTarget);
                      }
                      ListSequence.fromList(nfrl1).clear();
                      ListSequence.fromList(nfrl2).clear();
                      ListSequence.fromList(nfrl3).clear();
                ...
                {
                  Iterator<SNode> software_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(subcomp_var, LINKS.mobilerobot$ZnYh), LINKS.software$84Ys)).iterator();
                  SNode software_var;
                  while (software_it.hasNext()) {
                    software_var = software_it.next();
                    {
                      Iterator<SNode> nfr_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(software_var, LINKS.software$7j_c), LINKS.component$pKqJ), LINKS.nfr$Ta7D)).iterator();
                      SNode nfr_var;
                      while (nfr_it.hasNext()) {
                        nfr_var = nfr_it.next();
                        SEnumerationLiteral NFRname = SPropertyOperations.getEnum(nfr_var, PROPS.nfrmetric$_HW4);
                        ...
                        if (scenarioid == scenarioinstname) {
                          String nfrscid = SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(scenarioinst_var, LINKS.associatedNFR$9uGq), LINKS.instances$J4Ji), PROPS.name$MnvL);
                          {
                            ...
                            while (id_it.hasNext()) {
                              id_var = id_it.next();
                              if (id_var == nfrscid) {
                                int index = ListSequence.fromList(NFR_idListall).indexOf(id);
                                ListSequence.fromList(NFR_mostlikelyvalues).setElement(index, Double.valueOf(SPropertyOperations.getString(scenarioinst_var, PROPS.mostlikely$C2PP)));
                              }
                            }
                          }
                    ...
                    vars = "v";
                    {
                      Iterator<SNode> fgoal_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(software_var, LINKS.software$7j_c), LINKS.component$pKqJ), LINKS.tasks$CSig)).iterator();
                      SNode fgoal_var;
                      while (fgoal_it.hasNext()) {
                        fgoal_var = fgoal_it.next();
                        String goalName = SPropertyOperations.getString(fgoal_var, PROPS.name$MnvL);
                        String objective = "Scenario - " + scenarioid + " Mobile Robot: " + SPropertyOperations.getString(SLinkOperations.getTarget(robot_var, LINKS.mobilerobot$ZnYh), PROPS.name$MnvL) + " Sub Component: " + SPropertyOperations.getString(SLinkOperations.getTarget(subcomp_var, LINKS.mobilerobot$ZnYh), PROPS.name$MnvL) + " Software: " + SPropertyOperations.getString(SLinkOperations.getTarget(software_var, LINKS.software$7j_c), PROPS.name$MnvL) + " Functional Objective: " + fgoal_var;
                        // Creation of Objective Function
                        {
                          Iterator<SNode> goal2_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(software_var, LINKS.software$7j_c), LINKS.component$pKqJ), LINKS.association$CXUC)).iterator();
                          SNode goal2_var;
                          while (goal2_it.hasNext()) {
                            goal2_var = goal2_it.next();
                            String goalName2 = SPropertyOperations.getString(SLinkOperations.getTarget(goal2_var, LINKS.tasks$SHnI), PROPS.name$MnvL);
                        ...
                        {
                          final MessageTarget errorTarget = new NodeMessageTarget();
                          IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(system, objective, "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "1947599972197877692", null, errorTarget);
                        }
                        ListSequence.fromList(nfrl1).clear();
                        ListSequence.fromList(nfrl2).clear();
                        ListSequence.fromList(nfrl3).clear();
