...
public class NFRNormalization_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode hardwareComponent, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
          ...
          if (pair1flag == 1) {
            ...
            if ((value1 >= 0.5 && value1 <= 1.0) && (value2 >= 0.0 && value2 < 0.5)) {
              ...
              if (t < 0.25) {
                {
                  final MessageTarget errorTarget = new NodeMessageTarget();
                  IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(hardwareComponent, "The NFR pair " + pair3 + " are in conflict. They are at moderate risk. The impact relationship between them is polynomial. The initial expected values are : " + value1 + " and " + value2 + " respectively. For every increase of x in the value of " + nfrid1 + " the value of " + nfrid2 + " decreases by x^(10*k) where k is " + t + ".", "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "9048722257208419817", null, errorTarget);
                }
                ListSequence.fromList(nfrconflictsidenlist).addElement(pair4);
                ListSequence.fromList(nfrconflictimpList).addElement("Moderate");
                ListSequence.fromList(nfrconflictimpval).addElement(t);
          ...
          if (pair2flag == 1) {
            ...
            if ((value1 >= 0.0 && value1 < 0.5) && (value2 >= 0.5 && value2 <= 1.0)) {
              ...
              if (t >= 0.25) {
                ...
                {
                  final MessageTarget errorTarget = new NodeMessageTarget();
                  IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(hardwareComponent, "The NFR pair " + pair3 + " are in conflict. They are at moderate risk. The impact relationship between them is polynomial. The initial expected values are : " + value1 + " and " + value2 + " respectively. For every increase of x in the value of " + nfrid1 + " the value of " + nfrid2 + " decreases by x^(10*k) where k is " + t + ".", "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "9048722257207979861", null, errorTarget);
                }
                ListSequence.fromList(nfrconflictsidenlist).addElement(pair4);
                ListSequence.fromList(nfrconflictimpList).addElement("Moderate");
                ListSequence.fromList(nfrconflictimpval).addElement(t);
            ...
            if ((value1 >= 0.5 && value1 <= 1.0) && (value2 >= 0.0 && value2 < 0.5)) {
              ...
              if (t < 0.25) {
                {
                  final MessageTarget errorTarget = new NodeMessageTarget();
                  IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(hardwareComponent, "The NFR pair " + pair3 + " are in conflict. They are at moderate risk. The impact relationship between them is polynomial. The initial expected values are : " + value1 + " and " + value2 + " respectively. For every increase of x in the value of " + nfrid1 + " the value of " + nfrid2 + " decreases by x^(10*k) where k is " + t + ".", "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "9048722257208455743", null, errorTarget);
                }
                ListSequence.fromList(nfrconflictsidenlist).addElement(pair4);
                ListSequence.fromList(nfrconflictimpList).addElement("Moderate");
                ListSequence.fromList(nfrconflictimpval).addElement(t);
                ...
                {
                  final MessageTarget errorTarget = new NodeMessageTarget();
                  IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(hardwareComponent, "The NFR pair " + pair3 + " are in conflict. They are at high risk. The impact relationship between them is exponential. The initial expected values are : " + value1 + " and " + value2 + " respectively. For every increase of x in the value of " + nfrid1 + " the value of " + nfrid2 + " decreases by e^(10*k*x) where k is " + t + ".", "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "9048722257208462036", null, errorTarget);
                }
                ListSequence.fromList(nfrconflictsidenlist).addElement(pair4);
                ListSequence.fromList(nfrconflictimpList).addElement("High");
                ListSequence.fromList(nfrconflictimpval).addElement(t);
    ...
    {
      Iterator<SNode> goal_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(hardwareComponent, LINKS.component$ISi3), LINKS.tasks$8noB)).iterator();
      SNode goal_var;
      while (goal_it.hasNext()) {
        ...
        {
          Iterator<SNode> goal2_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(hardwareComponent, LINKS.component$ISi3), LINKS.association$8nBC)).iterator();
          SNode goal2_var;
        ...
        // Match the NFR ids with the NFR component of the specification
        {
          ...
          while (nfr_it.hasNext()) {
            nfr_var = nfr_it.next();
            {
              Iterator<SNode> nfr2_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(hardwareComponent, LINKS.component$ISi3), LINKS.nfr$8n9A)).iterator();
              SNode nfr2_var;
        ...
        {
          final MessageTarget errorTarget = new NodeMessageTarget();
          IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(hardwareComponent, "For goal " + goalName + " Objective function is - Maximize: " + temp, "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "3871314211646745187", null, errorTarget);
        }
        ...
        {
          final MessageTarget errorTarget = new NodeMessageTarget();
          IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(hardwareComponent, "For goal " + goalName + " Range constraint is " + temp, "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "3871314211646403222", null, errorTarget);
        }
            ...
            // check it against existing list
            {
              ...
              while (conflict_it.hasNext()) {
                ...
                if (conflict_var.compareTo(testpair1) == 0) {
                  ...
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(hardwareComponent, "Conflict constraint for : " + goalName + " is " + cons, "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "3871314211646393708", null, errorTarget);
                  }
                  ...
                  {
                    final MessageTarget errorTarget = new NodeMessageTarget();
                    IErrorReporter _reporter_2309309498 = typeCheckingContext.reportWarning(hardwareComponent, "Conflict constraint for : " + goalName + " is " + cons, "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "3871314211646368713", null, errorTarget);
                  }
