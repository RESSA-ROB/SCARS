...
public class TestingNFRConflictSystem_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public TestingNFRConflictSystem_NonTypesystemRule() {
  }
  public void applyRule(final SNode system, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    for (SNode scenario : ListSequence.fromList(SLinkOperations.getChildren(system, LINKS.scenario$OBZg))) {
      String scenarioid = SPropertyOperations.getString(scenario, PROPS.name$MnvL);
      String concat = "Scenario: " + scenarioid + " || System --> " + SPropertyOperations.getString(system, PROPS.name$MnvL);
      {
        Iterator<SNode> nfr_it = ListSequence.fromList(SLinkOperations.getChildren(system, LINKS.NFR$9zIQ)).iterator();
        SNode nfr_var;
      ...
      for (String item : NFR_names) {
        ...
        if (item.contains("Robustness")) {
          flag = 1;
          double temp = Double.valueOf(ListSequence.fromList(NFR_mostlikelyValues).getElement(index));
          if (mostlikely2 == 0) {
            mostlikely2 = temp;
          }
          if (mostlikely2 >= temp) {
      ...
      {
        Iterator<SNode> fgoal_it = ListSequence.fromList(SLinkOperations.getChildren(system, LINKS.requirements$JIUD)).iterator();
        SNode fgoal_var;
        while (fgoal_it.hasNext()) {
          fgoal_var = fgoal_it.next();
          String goalName = SPropertyOperations.getString(fgoal_var, PROPS.name$MnvL);
          String objective = "Scenario - " + scenarioid + " System : " + SPropertyOperations.getString(system, PROPS.name$MnvL) + " Functional Objective : " + goalName;
          // Creation of Objective Function
          {
            Iterator<SNode> goal2_it = ListSequence.fromList(SLinkOperations.getChildren(system, LINKS.association$auH)).iterator();
            SNode goal2_var;
            while (goal2_it.hasNext()) {
              goal2_var = goal2_it.next();
              String goalName2 = SPropertyOperations.getString(SLinkOperations.getTarget(goal2_var, LINKS.tasks$9PbI), PROPS.name$MnvL);

              if (goalName.compareTo(goalName2) == 0) {
                // Now store the NFR id in the nfrvarlist and dependency value in the nfrdepval list
                ListSequence.fromList(nfrvarList2).addElement(SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(goal2_var, LINKS.NFRs$9OHG), LINKS.instances$J4Ji), PROPS.name$MnvL));
                ListSequence.fromList(nfrdepval2).addElement(SPropertyOperations.getInteger(goal2_var, PROPS.value$kax2));
              }
            }
          }
          String temp = "";
          ...
          // Fetching of NFR
          {
            ...
            while (goal2_it.hasNext()) {
              ...
              String goalName2 = SPropertyOperations.getString(SLinkOperations.getTarget(goal2_var, LINKS.tasks$9PbI), PROPS.name$MnvL);
              if (goalName.compareTo(goalName2) == 0) {
                SEnumerationLiteral NFRname = SPropertyOperations.getEnum(SLinkOperations.getTarget(SLinkOperations.getTarget(goal2_var, LINKS.NFRs$9OHG), LINKS.instances$J4Ji), PROPS.nfrmetric$_HW4);
                String ids = SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(goal2_var, LINKS.NFRs$9OHG), LINKS.instances$J4Ji), PROPS.name$MnvL);
                String NFRnameactual = "";
                if (NFRname.equals(SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xddad85b58f7640d8L, 0x9a0dbd322c713e77L, 0x2405e2b0a9050702L, "NFR.structure.NFR_metric_names"), 0x2405e2b0a907f810L, "Calmness_calmTiming"))) {
                  NFRnameactual = "Calmness";
                  // w1
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty value$kax2 = MetaAdapterFactory.getProperty(0x79fb875b5c4f4986L, 0x892e2475e9d0c842L, 0x4430c773569747ebL, 0x792cca2b721af406L, "value");
  }
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink tasks$9PbI = MetaAdapterFactory.getReferenceLink(0x79fb875b5c4f4986L, 0x892e2475e9d0c842L, 0x4430c773569747ebL, 0x4430c773569747eeL, "tasks");
    /*package*/ static final SContainmentLink NFRs$9OHG = MetaAdapterFactory.getContainmentLink(0x79fb875b5c4f4986L, 0x892e2475e9d0c842L, 0x4430c773569747ebL, 0x4430c773569747ecL, "NFRs");
