...
public class ConflictCheckingForSoftwareComponent_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public ConflictCheckingForSoftwareComponent_NonTypesystemRule() {
  }
        ...
        if (ListSequence.fromList(NFR_conflict_pair).indexOf(pair1) != -1) {
          {
            ...
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(softwareComponent, "The NFR pair " + pair3 + " are in conflict", "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "1619724259207888892", null, errorTarget);
          }
        } else if (ListSequence.fromList(NFR_conflict_pair).indexOf(pair2) != -1) {
          {
            final MessageTarget errorTarget = new NodeMessageTarget();
            IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(softwareComponent, "The NFR pair " + pair3 + " are in conflict", "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "1619724259207888913", null, errorTarget);
          }
        }
      }
    }
