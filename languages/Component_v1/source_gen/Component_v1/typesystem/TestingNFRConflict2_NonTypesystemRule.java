              ...
              while (scomp_it.hasNext()) {
...

                {
                  ...
                  while (fgoal_it.hasNext()) {
                    ...
                    for (int i1 = 0; i1 < sizel; i1++) {
                      ...
                      for (int j1 = i1 + 1; j1 < sizel; j1++) {
                        ...
                        String pair2 = nfr2 + "-" + nfr1;
                        {
                          ...
                          IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(system, "Pair 1 " + pair1 + " Pair 2 " + pair2, "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "2599269916502485736", null, errorTarget);
                        }
                        String item1 = "";
                        String item2 = "";
                        int index1 = 0;
                    ...
                    {
                      final MessageTarget errorTarget = new NodeMessageTarget();
                      IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(system, objective, "r:1524284d-b0a0-4e87-9b87-3259ef92f715(Component_v1.typesystem)", "2599269916502486400", null, errorTarget);
                    }
