...
public class TestingNFRConflict1_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  public TestingNFRConflict1_NonTypesystemRule() {
  }
  public void applyRule(final SNode system, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
...

    {
      ...
      while (scenario_it.hasNext()) {
        ...
        // Fetch data for each external hardware component
        {
          Iterator<SNode> exHC_it = Sequence.fromIterable(SLinkOperations.collect(SLinkOperations.getChildren(system, LINKS.externalHardware$ZgeK), LINKS.hardware$nR7k)).iterator();
          SNode exHC_var;
          while (exHC_it.hasNext()) {
            exHC_var = exHC_it.next();
            String concat = "Scenario - " + scenarioid + "|| Hardware Component: ";
            String exHCname = SPropertyOperations.getString(exHC_var, PROPS.name$MnvL);
            concat = concat + exHCname;
            {
              Iterator<SNode> nfr_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(exHC_var, LINKS.component$ISi3), LINKS.nfr$8n9A)).iterator();
              SNode nfr_var;
              while (nfr_it.hasNext()) {
                nfr_var = nfr_it.next();
                SEnumerationLiteral NFRname = SPropertyOperations.getEnum(nfr_var, PROPS.nfrmetric$_HW4);
                String max = SPropertyOperations.getString(nfr_var, PROPS.maxvalue$_Ib5);
                String min = SPropertyOperations.getString(nfr_var, PROPS.minvalue$_Iq6);
                String mostlikely = SPropertyOperations.getString(nfr_var, PROPS.mostlikely$_N$s);
                String id = SPropertyOperations.getString(nfr_var, PROPS.name$MnvL);
            ...
            }
            {
              ...
              while (item_it.hasNext()) {
                ...
                int i = ListSequence.fromList(NFRnames_ExpectedList).indexOf(item_var);
            ...
            {
              Iterator<String> name_it = ListSequence.fromList(NFR_nameListDummy).iterator();
              String name_var;
            ...
            {
              Iterator<String> ids_it = ListSequence.fromList(NFR_idListconcise).iterator();
              String ids_var;
            ...
            {
              Iterator<String> item_it = ListSequence.fromList(NFR_namesList).iterator();
              String item_var;
              while (item_it.hasNext()) {
                item_var = item_it.next();
              }
            ...
            {
              Iterator<SNode> fgoal_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(exHC_var, LINKS.component$ISi3), LINKS.tasks$8noB)).iterator();
              SNode fgoal_var;
              while (fgoal_it.hasNext()) {
                fgoal_var = fgoal_it.next();
                String goalName = SPropertyOperations.getString(fgoal_var, PROPS.name$MnvL);
                String objective = "Scenario - " + scenarioid + " External Hardware: " + exHCname + " Functional Objective: " + goalName;
        ...
        ListSequence.fromList(NFR_minValues).clear();
        ListSequence.fromList(NFR_mostlikelyValues).clear();
        // Fetch data for each mobile robot
        {
          ...
          while (robot_it.hasNext()) {
            ...
            String robotid = SPropertyOperations.getString(SLinkOperations.getTarget(robot_var, LINKS.mobilerobot$ZnYh), PROPS.name$MnvL);
            String concat = "Scenario: " + scenarioid + " || Robot: " + robotid;
            {
              Iterator<SNode> nfrrobot_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(robot_var, LINKS.mobilerobot$ZnYh), LINKS.nfr$86Bz)).iterator();
              SNode nfrrobot_var;
              while (nfrrobot_it.hasNext()) {
                nfrrobot_var = nfrrobot_it.next();
                SEnumerationLiteral NFRname = SPropertyOperations.getEnum(nfrrobot_var, PROPS.nfrmetric$_HW4);
                String max = SPropertyOperations.getString(nfrrobot_var, PROPS.maxvalue$_Ib5);
                String min = SPropertyOperations.getString(nfrrobot_var, PROPS.minvalue$_Iq6);
                String mostlikely = SPropertyOperations.getString(nfrrobot_var, PROPS.mostlikely$_N$s);
                String id = SPropertyOperations.getString(nfrrobot_var, PROPS.name$MnvL);
                ListSequence.fromList(NFR_maxValues).addElement(Double.valueOf(max));
                ListSequence.fromList(NFR_minValues).addElement(Double.valueOf(min));
                ListSequence.fromList(NFR_mostlikelyValues).addElement(Double.valueOf(mostlikely));
                ListSequence.fromList(NFR_idList).addElement(id);
            ...
            int dummyListIndex = 0;
            {
              Iterator<SNode> nfr_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(robot_var, LINKS.mobilerobot$ZnYh), LINKS.nfr$86Bz)).iterator();
              SNode nfr_var;
              while (nfr_it.hasNext()) {
                nfr_var = nfr_it.next();
                SEnumerationLiteral NFRname = SPropertyOperations.getEnum(nfr_var, PROPS.nfrmetric$_HW4);
            ...
            {
              Iterator<SNode> fgoal_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(robot_var, LINKS.mobilerobot$ZnYh), LINKS.tasks$h26j)).iterator();
              SNode fgoal_var;
              while (fgoal_it.hasNext()) {
                fgoal_var = fgoal_it.next();
                String goalName = SPropertyOperations.getString(fgoal_var, PROPS.name$MnvL);
                String objective = "Scenario - " + scenarioid + " Mobile Robot: " + robotid + " Functional Objective: " + goalName;
                // Creation of Objective Function
                {
                  ...
                  while (goal2_it.hasNext()) {
                    goal2_var = goal2_it.next();
                    String goalName2 = SPropertyOperations.getString(SLinkOperations.getTarget(goal2_var, LINKS.tasks$Yzhc), PROPS.name$MnvL);

                    if (goalName.compareTo(goalName2) == 0) {
                      // Now store the NFR id in the nfrvarlist and dependency value in the nfrdepval list
                      ListSequence.fromList(nfrvarList2).addElement(SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(goal2_var, LINKS.NFRs$MSud), LINKS.instances$J4Ji), PROPS.name$MnvL));
                      ListSequence.fromList(nfrdepval2).addElement(SPropertyOperations.getInteger(goal2_var, PROPS.value$Fo95));
                    }
                  }
                }
                String temp = "";
                ...
                // Fetching of NFR
                {
                  ...
                  while (goal2_it.hasNext()) {
                    ...
                    String goalName2 = SPropertyOperations.getString(SLinkOperations.getTarget(goal2_var, LINKS.tasks$Yzhc), PROPS.name$MnvL);
                    if (goalName.compareTo(goalName2) == 0) {
                      SEnumerationLiteral NFRname = SPropertyOperations.getEnum(SLinkOperations.getTarget(SLinkOperations.getTarget(goal2_var, LINKS.NFRs$MSud), LINKS.instances$J4Ji), PROPS.nfrmetric$_HW4);
                      String ids = SPropertyOperations.getString(SLinkOperations.getTarget(SLinkOperations.getTarget(goal2_var, LINKS.NFRs$MSud), LINKS.instances$J4Ji), PROPS.name$MnvL);
                      String NFRnameactual = "";
                      if (NFRname.equals(SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xddad85b58f7640d8L, 0x9a0dbd322c713e77L, 0x2405e2b0a9050702L, "NFR.structure.NFR_metric_names"), 0x2405e2b0a907f810L, "Calmness_calmTiming"))) {
                        NFRnameactual = "Calmness";
                        // w1
            ...
            // Clearing arrays before fetching next robot
            ListSequence.fromList(NFR_names).clear();
            ListSequence.fromList(NFR_idList).clear();
            ListSequence.fromList(NFR_maxValues).clear();
            ListSequence.fromList(NFR_minValues).clear();
        ...
        ListSequence.fromList(NFR_minValues).clear();
        ListSequence.fromList(NFR_mostlikelyValues).clear();
        // Fetch data for internal hardware component of each robot
        {
          Iterator<SNode> robot2_it = ListSequence.fromList(SLinkOperations.getChildren(system, LINKS.robots$ZlC7)).iterator();
          SNode robot2_var;
          while (robot2_it.hasNext()) {
            robot2_var = robot2_it.next();
            {
              Iterator<SNode> hcomp_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(robot2_var, LINKS.mobilerobot$ZnYh), LINKS.hardware$7Z_5)).iterator();
              SNode hcomp_var;
              while (hcomp_it.hasNext()) {
                hcomp_var = hcomp_it.next();
                String concat = "Scenario: " + scenarioid + " || Mobile Robot " + SPropertyOperations.getString(SLinkOperations.getTarget(robot2_var, LINKS.mobilerobot$ZnYh), PROPS.name$MnvL) + " --> Hardware Component: " + SPropertyOperations.getString(SLinkOperations.getTarget(hcomp_var, LINKS.hardware$nR7k), PROPS.name$MnvL);
                {
                  Iterator<SNode> nfrhcomp_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(hcomp_var, LINKS.hardware$nR7k), LINKS.component$ISi3), LINKS.nfr$8n9A)).iterator();
                  SNode nfrhcomp_var;
                  while (nfrhcomp_it.hasNext()) {
                    nfrhcomp_var = nfrhcomp_it.next();
                    SEnumerationLiteral NFRname = SPropertyOperations.getEnum(nfrhcomp_var, PROPS.nfrmetric$_HW4);
                    String max = SPropertyOperations.getString(nfrhcomp_var, PROPS.maxvalue$_Ib5);
                    String min = SPropertyOperations.getString(nfrhcomp_var, PROPS.minvalue$_Iq6);
                    String mostlikely = SPropertyOperations.getString(nfrhcomp_var, PROPS.mostlikely$_N$s);
                    String id = SPropertyOperations.getString(nfrhcomp_var, PROPS.name$MnvL);
                    ListSequence.fromList(NFR_maxValues).addElement(Double.valueOf(max));
                    ListSequence.fromList(NFR_minValues).addElement(Double.valueOf(min));
                    ListSequence.fromList(NFR_mostlikelyValues).addElement(Double.valueOf(mostlikely));
                    ListSequence.fromList(NFR_idList).addElement(id);
                ...
                int dummyListIndex = 0;
                {
                  Iterator<SNode> nfr_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(hcomp_var, LINKS.hardware$nR7k), LINKS.component$ISi3), LINKS.nfr$8n9A)).iterator();
                  SNode nfr_var;
                  while (nfr_it.hasNext()) {
                    nfr_var = nfr_it.next();
                    SEnumerationLiteral NFRname = SPropertyOperations.getEnum(nfr_var, PROPS.nfrmetric$_HW4);
                ...
                {
                  Iterator<SNode> fgoal_it = ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(SLinkOperations.getTarget(hcomp_var, LINKS.hardware$nR7k), LINKS.component$ISi3), LINKS.tasks$8noB)).iterator();
                  SNode fgoal_var;
                  while (fgoal_it.hasNext()) {
                    fgoal_var = fgoal_it.next();
                    String goalName = SPropertyOperations.getString(fgoal_var, PROPS.name$MnvL);
                    String objective = "Scenario - " + scenarioid + " Mobile Robot: " + SPropertyOperations.getString(SLinkOperations.getTarget(robot2_var, LINKS.mobilerobot$ZnYh), PROPS.name$MnvL) + " Hardware Component: " + SPropertyOperations.getString(SLinkOperations.getTarget(hcomp_var, LINKS.hardware$nR7k), PROPS.name$MnvL) + " Functional Objective: " + goalName;
                    // Creation of Objective Function
                    {
