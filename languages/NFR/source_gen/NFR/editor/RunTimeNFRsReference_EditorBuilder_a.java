...
/*package*/ class RunTimeNFRsReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RunTimeNFRsReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_qpnde1_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.field$OPvo;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.field$OPvo);
    }
