...
/*package*/ class RunTimeNFRs2_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RunTimeNFRs2_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_teudg5_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_teudg5_a0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_teudg5_a0a");
  ...
  private EditorCell createCollection_2() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_teudg5_b0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_teudg5_a1a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new attributesListHandler_teudg5_b1a(myNode, getEditorContext());
  ...
  private static class attributesListHandler_teudg5_b1a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public attributesListHandler_teudg5_b1a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(attributesListHandler_teudg5_b1a.this.getNode(), LINKS.attributes$uwJl));
      try {
  ...
  private EditorCell createCollection_3() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_teudg5_c0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("Constant_teudg5_a2a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createEmpty_0() {
    ...
    editorCell.setCellId("Empty_teudg5_d0");
    return editorCell;
  }
