...
/*package*/ class LocalRunTimeNFRsInst_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public LocalRunTimeNFRsInst_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_qsbqps_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_qsbqps_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.instance$ezOM;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.instance$ezOM);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.instance$ezOM);
    }
