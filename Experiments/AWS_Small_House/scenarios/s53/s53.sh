#!/bin/bash
SCRIPT_PATH="/home/misfit/create3_ws/expb/scenarios/s53/d53.sh"
...
ros2 action send_goal /drive_distance irobot_create_msgs/action/DriveDistance "{distance: 7.7,max_translation_speed: 0.454}"
