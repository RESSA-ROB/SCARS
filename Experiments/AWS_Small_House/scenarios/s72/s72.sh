#!/bin/bash
SCRIPT_PATH="/home/misfit/create3_ws/expb/scenarios/s72/d72.sh"
...
ros2 action send_goal /drive_distance irobot_create_msgs/action/DriveDistance "{distance: 1.9,max_translation_speed: 0.454}"
