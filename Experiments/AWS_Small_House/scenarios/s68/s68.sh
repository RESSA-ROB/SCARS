#!/bin/bash
SCRIPT_PATH="/home/misfit/create3_ws/expb/scenarios/s68/d68.sh"
...
ros2 action send_goal /drive_distance irobot_create_msgs/action/DriveDistance "{distance: 1.1,max_translation_speed: 0.454}"
...
ros2 action send_goal /drive_distance irobot_create_msgs/action/DriveDistance "{distance: 1.3,max_translation_speed: 0.3}"
