#!/bin/bash
SCRIPT_PATH="/home/misfit/create3_ws/expb/scenarios/s47/d47.sh"
...
ros2 action send_goal /drive_distance irobot_create_msgs/action/DriveDistance "{distance: 2.5,max_translation_speed: 0.454}"
