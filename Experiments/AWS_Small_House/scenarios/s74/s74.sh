#!/bin/bash
SCRIPT_PATH="/home/misfit/create3_ws/expb/scenarios/s74/d74.sh"
...
ros2 action send_goal /rotate_angle irobot_create_msgs/action/RotateAngle "{angle: -0.27,max_rotation_speed: 1.9}"
