#!/bin/bash
SCRIPT_PATH="/home/misfit/create3_ws/expb/scenarios/s95/d95_1.sh"
SCRIPT_PATH2="/home/misfit/create3_ws/expb/scenarios/s95/d95_2.sh"
...
ros2 action send_goal /drive_distance irobot_create_msgs/action/DriveDistance "{distance: 5,max_translation_speed: 0.4}"
