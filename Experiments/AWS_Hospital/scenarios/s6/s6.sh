#!/bin/bash
SCRIPT_PATH="/home/misfit/create3_ws/expc/scenarios/s6/d6.sh"
...
ros2 action send_goal /drive_distance irobot_create_msgs/action/DriveDistance "{distance: 2.7,max_translation_speed: 0.46}"
